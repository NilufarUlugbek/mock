...
namespace DSBD
{
    class Answers
    {
        use AdventureWorks2012 EXEC sp_changedbowner 'sa' ALTER AUTHORIZATION ON DATABASE::AdventureWorks2012 TO sa
        
        1.Count how many different jobtitles exist among employees.
        ...
        select jobtitle, HireDate, pp.FirstName, pp.LastName 
        ...
        9.Show list of employees ordered by department, employee rate and minimum rate for department this employee works at.
        For each employee show the difference between lowest rate in the department where employee works and his own salary.
